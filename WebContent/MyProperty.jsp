							...
							<div class="dashboard-navbar">
								...
								<div class="d-navigation">
									<ul>
										...
										<li class="active"><a href="MyProperty.jsp"><i class="ti-layers"></i>My Properties</a></li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-9 col-md-12">
					<div class="dashboard-wraper">
						...
						<table class="property-table-wrap responsive-table bkmark">
							...
							<tbody>
								<tr>
									<th><i class="fa fa-file-text"></i>My Properties</th>
									<th></th>
								</tr>
								...
								<tr>
									...
									<td class="action"><a href="PropertyDetail.jsp" class="delete"><i
											class="ti-eye"></i> View</a></td>
								</tr>
						...
						<div class="header-right-btn f-right">								
								<a href="AddProperty.jsp" class="btn_submit">New Property</a>
						</div>
					</div>
				</div>
