...
<body onload="getDate01()">
	...
	<div id="top_nav">
	 	<span id="here_area">Currently: Management System&nbsp;>&nbsp;Introduction</span>
	</div>
	
    <div id="main">
      	<iframe name="right" id="rightMain" src="Admin_intro.jsp" style="frameborder:no;scrolling:auto;width:100%;height:100%;allowtransparency:true">
      	</iframe>
    </div>
