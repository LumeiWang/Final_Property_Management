...
<body onload="getDate01()">
	...
	<div id="top_nav">
	 	<span id="here_area">Currently: Data&nbsp;>&nbsp;Property Information</span>
	</div>
	
    <div id="main">
      	<iframe name="right" id="rightMain" src="propertyList" style="frameborder:no;scrolling:auto;width:100%;height:100%;allowtransparency:true">
      	</iframe>
    </div>
